...
function loadConfig() {
  try {
    ...
    // Extract footer configuration explicitly
    const footerConfig = parsedConfig.navigation?.footer || {};
    console.log('Loaded footer configuration:', footerConfig); // Debug log

    return { ...parsedConfig, footerConfig };
  } catch (error) {
